...
az network nsg rule create -g $RG --nsg-name $NSG -n Allow8080 --priority 4096 --source-port-ranges * --destination-port-ranges 8080 --access Allow --protocol Tcp --description "Allow 8080."
